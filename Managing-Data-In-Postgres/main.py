...
def book_tickets(tk, country):
    ...
    Button(root, text="Send Request", bg="blue", fg="white",
           command=lambda: show_ticket(tk, name=name.get(), surname=surname.get(), email=email.get())).grid(row=6,
                                                                                                            column=1,
                                                                                                            padx=70,
                                                                                                            pady=20)
    Button(root, text="Home Page", bg="red", fg="white", command=lambda: render_main_view(tk)).grid(row=6, column=0,
                                                                                                    padx=70, pady=20)
...
def render_main_view(tk):
    ...
    Button(root, text="Book your tickets", bg="blue", fg="white",
           command=lambda: book_tickets(tk, country=var.get())).grid(row=6, column=1, padx=70, pady=20)
